...
if(autoclearFinishedJobs){
	...
	setInterval(function(){
		...
		redisClient.info(setCmd,function(err,res){

			console.log(_.pick(redisClient.server_info,['used_cpu_sys','used_cpu_user','connected_clients','used_memory','used_memory_human','used_memory_peak','used_memory_peak_human']))
		})
